...
export const ResumeCv005 = ({
  ...
  //       let profile_block = $('#cv-body-hidden-container .profile-block').clone();
  ...
  //       let bottom_block = $('#cv-body-hidden-container .bottom-block').clone();

  //       getPageArea1().append(photo_block);
  //       getPageArea1().append(profile_block);

  //       // Column left
  //       current_page_number = 1;
  //       getPageColumnLeft().append(details_block);
  ...
  //       // Center block
  //       current_page_number = 1;
  //       getPageColumnCenter().append(courses_block);
  //       if (getPageContainer().height() > getPageContainer().parent().height()) {
  ...
  //       getPageColumnCenter().append(certificates_block);
  //       if (getPageContainer().height() > getPageContainer().parent().height()) {
  ...
  //       getPageColumnCenter().append(extra_curricular_activities_block);
  //       if (getPageContainer().height() > getPageContainer().parent().height()) {
  ...
  //       getPageColumnCenter().append(internships_block);
  //       if (getPageContainer().height() > getPageContainer().parent().height()) {
  ...
  //       console.log("Current:Max: ", current_page_number, max_page_number);
  ...
  //     function getPageColumnCenter() {
  //       return getPageArea2().find('.column-2');
  //     }

  //     function getPageColumnRight() {
  //       return getPageArea2().find('.column-3');
  //     }
  ...
  //       let page_element = $('<div className="cv-body cv-body-visible cv-body-1 page-' + page_number + '" data-chapter="cv" data-page="' + page_number + '"></div>');
  //       page_element.attr('data-chapter', 'cv');
  //       page_element.attr('data-page', page_number);
  //       let page_element_container = $('<div className="cv-body-content"></div>');
  //       page_element.append(page_element_container);

  //       if (current_page_number == 1) {
  //         let top_area = $('<div className="cv-body-area top-area"></div>');
  //         page_element_container.append(top_area);
  //       }

  //       let middle_area = $('<div className="cv-body-area middle-area"></div>');
  //       middle_area.append('<div className="column-1"></div>');
  //       middle_area.append('<div className="column-2"></div>');
  //       middle_area.append('<div className="column-3"></div>');
  //       page_element_container.append(middle_area);

  //       let bottom_area = $('#cv-body-hidden-container .bottom-area').clone();
        ...
        <div id="cv-body-hidden-container" className="cv-body cv-body-1">
          <div className="cv-body-content">
            <div className="cv-body-area top-area">
              ...
              <div className="profile-block profile-info-wrapper">
                <h1 className="cv-name">
                  <span className="text-line-1 main-color-1-text font-weight-400 font-size-5 line-height-5">Matthew</span>
                  <span className="text-line-2 main-color-1-text font-weight-700 font-size-4 line-height-4">Mcconaghey</span>
                </h1>
                <h2 className="prophecy-line main-color-1-text font-weight-400 font-size-3 line-height-3">WEB-DESIGNER</h2>
                <p className="profile-text main-color-1-text font-size-1 line-height-1">
            ...
            <div className="cv-body-area middle-area">
              <div className="column-1">
                <div className="details-block block-block">
                  <h3 className="heading-type-3 main-color-1-text font-weight-700 font-size-2 line-height-2">Details</h3>
                  <span className="horizontal-line additional-color-1-border"></span>
                  <div className="details-wrapper">
                    <div className="details-item font-size-1 line-height-1">
                      <span className="item-name main-color-1-text font-weight-300">Birth Date</span>
                      <span className="item-value main-color-1-text font-weight-500">14-08-1991</span>
                    </div>
                    <div className="details-item font-size-1 line-height-1">
                      <span className="item-name main-color-1-text font-weight-300 font-size-1 line-height-1">Place of Birth</span>
                      <span className="item-value main-color-1-text font-weight-500 font-size-1 line-height-1">Berlin</span>
                    </div>
                    <div className="details-item font-size-1 line-height-1">
                      <span className="item-name main-color-1-text font-weight-300">Nationality</span>
                      <span className="item-value main-color-1-text font-weight-500">German</span>
                    </div>
                    <div className="details-item font-size-1 line-height-1">
                      <span className="item-name main-color-1-text font-weight-300 font-size-1 line-height-1">Driving Licence</span>
                      <span className="item-value main-color-1-text font-weight-500 font-size-1 line-height-1">Class 1</span>
                    </div>
                  </div>
                </div>
                <div className="education-block block-block">
                  ...
                  <span className="horizontal-line additional-color-1-border"></span>
                  <p className="font-weight-600 main-color-1-text font-size-1 line-height-1">Marketing and Management, Harcum College, Portland</p>
                  <p className="font-weight-600 main-color-1-text font-size-1 line-height-1">Bachelor</p>
                  <p className="date-range font-weight-300 font-size-1 line-height-1">July 2022 ― August 2022</p>
                  <p className="font-size-1 line-height-1">I have learned to merge marketing and management skills in a very efficient way and
                    produce great results. Even though managing hundreds of people is hard, all skills
                    are learned to do that.
                  </p>
                </div>
                <div className="employment-history-block block-block">
                  <h3 className="heading-type-3 main-color-1-text font-weight-700 font-size-2 line-height-2">Employment History</h3>
                  <span className="horizontal-line additional-color-1-border"></span>
                  <p className="main-color-1-text font-weight-600 font-size-1 line-height-1">Web Designer, Apple INC., New York City</p>
                  <p className="date-range font-weight-300 font-size-1 line-height-1">March 2022 ‒ December 2022</p>
                  <div className="main-color-1-text font-size-1 line-height-1">
                    <p>Helped to achieve a consistent look and visual theme across the website by
                      promoting uniform fonts, formatting, images, and layout.</p>
                    <p>Followed policies and procedures related to application methods and quality
                      standards at all times.</p>
                    <p>Managed front-end and back-end development in the company's Portfolio
                      Analyst, Employee Track, and Account Management systems.</p>
                  </div>
                </div>
              </div>
              <div className="column-2">
                <div className="courses-block block-block">
                  ...
                  <span className="horizontal-line additional-color-1-border"></span>
                  <p className="font-weight-600 main-color-1-text font-size-1 line-height-1">Super course 1</p>
                  <p className="date-range font-weight-300 font-size-1 line-height-1">July 2022 ― August 2022</p>
                  <p className="font-size-1 line-height-1">Benjamin Franklin Sidestep Collage, Portland</p>
                </div>
                <div className="certificates-block block-block">
                  <h3 className="heading-type-3 main-color-1-text font-weight-700 font-size-2 line-height-2">Certificates</h3>
                  <span className="horizontal-line additional-color-1-border"></span>
                  <p className="main-color-1-text font-weight-600 font-size-1 line-height-1">Certificate name</p>
                </div>
                <div className="extra-curricular-activities-block block-block">
                  <h3 className="heading-type-3 main-color-1-text font-weight-700 font-size-2 line-height-2">Extra-curricular activities</h3>
                  <span className="horizontal-line additional-color-1-border"></span>
                  <p className="main-color-1-text font-weight-600 font-size-1 line-height-1">UX Designer, My own company</p>
                  <p className="date-range main-color-1-text font-weight-300 font-size-1 line-height-1">March 2022 ‒ December 2022</p>
                  <p className="main-color-1-text font-size-1 line-height-1">I was doing research for about five different projects. The goal was to find out the
                ...
                <div className="internships-block block-block">
                  ...
                  <span className="horizontal-line additional-color-1-border"></span>
                  <p className="main-color-1-text font-weight-600 font-size-1 line-height-1">Product Designer, Company S.A., Toronto</p>
                  <p className="date-range main-color-1-text font-weight-300 font-size-1 line-height-1">March 2022 ‒ December 2022</p>
                  <div className="main-color-1-text font-size-1 line-height-1">
                    <p>Handled each product and package with care and precision.</p>
                    <p>Handled much of the communication between clients and the lead Graphic
                      Designer.
                    </p>
                    <p>Worked productively with Product Team to understand requirements and
              ...
              <div className="column-3">
                <div className="skills-block block-block">
                  <h3 className="heading-type-3 main-color-1-text font-weight-700 font-size-2 line-height-2">Skills</h3>
                  <span className="horizontal-line additional-color-1-border"></span>
                  <div className="skills-list">
                    <div className="skills-list-item">
                      <p className="skill-item-name main-color-1-text font-weight-600 font-size-1 line-height-1">Computer Skills</p>
                      <p className="skill-item-estimation-container main-color-4-border">
                        <span className="skill-item-estimation-value additional-color-1-background" style={{ width: "100%" }}></span>
                      </p>
                    </div>
                    <div className="skills-list-item">
                      <p className="skill-item-name main-color-1-text font-weight-600 font-size-1 line-height-1">Adobe Illustrator</p>
                      <p className="skill-item-estimation-container main-color-4-border">
                        <span className="skill-item-estimation-value additional-color-1-background" style={{ width: "85%" }}></span>
                      </p>
                    </div>
                    <div className="skills-list-item">
                      <p className="skill-item-name main-color-1-text font-weight-600 font-size-1 line-height-1">Adobe Premiere Pro</p>
                      <p className="skill-item-estimation-container main-color-4-border">
                        <span className="skill-item-estimation-value additional-color-1-background" style={{ width: "70%" }}></span>
                      </p>
                    </div>
                    <div className="skills-list-item">
                      <p className="skill-item-name main-color-1-text font-weight-600 font-size-1 line-height-1">PowerPoint</p>
                      <p className="skill-item-estimation-container main-color-4-border">
                        <span className="skill-item-estimation-value additional-color-1-background" style={{ width: "55%" }}></span>
                      </p>
                    </div>
                    <div className="skills-list-item">
                      <p className="skill-item-name main-color-1-text font-weight-600 font-size-1 line-height-1">HTML5</p>
                      <p className="skill-item-estimation-container main-color-4-border">
                        <span className="skill-item-estimation-value additional-color-1-background" style={{ width: "40%" }}></span>
                      </p>
                    </div>
                    <div className="skills-list-item">
                      <p className="skill-item-name main-color-1-text font-weight-600 font-size-1 line-height-1">CSS</p>
                      <p className="skill-item-estimation-container main-color-4-border">
                        <span className="skill-item-estimation-value additional-color-1-background" style={{ width: "width:35%" }}></span>
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="languages-block block-block">
                  <h3 className="heading-type-3 main-color-1-text font-weight-700 font-size-2 line-height-2">Languages</h3>
                  <span className="horizontal-line additional-color-1-border"></span>
                  <div className="languages-list">
                    <div className="languages-list-item">
                      <p className="languages-list-item-name main-color-1-text font-weight-600 font-size-1 line-height-1">English</p>
                      <p className="languages-skill-item-value">
                        <span className="item-value-point additional-color-1-border additional-color-1-background"></span>
                        <span className="item-value-point additional-color-1-border additional-color-1-background"></span>
                        <span className="item-value-point additional-color-1-border additional-color-1-background"></span>
                        <span className="item-value-point additional-color-1-border additional-color-1-background"></span>
                        <span className="item-value-point additional-color-1-border additional-color-1-background"></span>
                        <span className="item-value-point additional-color-1-border additional-color-1-background"></span>
                        <span className="item-value-point additional-color-1-border additional-color-1-background"></span>
                        <span className="item-value-point additional-color-1-border"></span>
                      </p>
                    </div>
                    <div className="languages-list-item">
                      <p className="languages-list-item-name main-color-1-text font-weight-600 font-size-1 line-height-1">Ukrainian</p>
                      <p className="languages-skill-item-value">
                        <span className="item-value-point additional-color-1-border additional-color-1-background"></span>
                        <span className="item-value-point additional-color-1-border additional-color-1-background"></span>
                        <span className="item-value-point additional-color-1-border additional-color-1-background"></span>
                    ...
                    <div className="languages-list-item">
                      <p className="languages-list-item-name main-color-1-text font-weight-600 font-size-1 line-height-1">Russian</p>
                      <p className="languages-skill-item-value">
                        <span className="item-value-point additional-color-1-border additional-color-1-background"></span>
                        <span className="item-value-point additional-color-1-border additional-color-1-background"></span>
                        <span className="item-value-point additional-color-1-border additional-color-1-background"></span>
                ...
                <div className="hobbies-block block-block">
                  <h3 className="heading-type-3 main-color-1-text font-weight-700 font-size-2 line-height-2">Hobbies</h3>
                  <span className="horizontal-line additional-color-1-border"></span>
                  <p className="main-color-1-text font-size-1 line-height-1">Squash, Surfing, Swimming,
                    Table tennis, Tennis, Tennis polo,
                    Tether car, Tour skating
                  </p>
                </div>

                <div className="references-block block-block">
                  <h3 className="headint-type-3 main-color-1-text font-weight-700 font-size-2 line-height-2">References</h3>
                  <span className="horizontal-line additional-color-1-border"></span>
                  <p className="company-name main-color-1-text font-weight-600 font-size-1 line-height-1">Full name, Company</p>
                  <p className="email main-color-1-text font-size-1 line-height-1">references@webservice.com</p>
                  <p className="telephone main-color-1-text font-size-1 line-height-1">736-343-9384</p>
                </div>
              </div>
            </div>
            <div className="cv-body-area bottom-area additional-color-1-background">
              <div className="bottom-block">
                <div className="footer-item">
                  ...
                  <span className="main-color-2-text font-size-1 line-height-1">736-343-9384</span>
                </div>
                <div className="footer-item">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12.6667 2.6665H3.33337C2.80294 2.6665 2.29423 2.87722 1.91916 3.25229C1.54409 3.62736 1.33337 4.13607 1.33337 4.6665V11.3332C1.33337 11.8636 1.54409 12.3723 1.91916 12.7474C2.29423 13.1225 2.80294 13.3332 3.33337 13.3332H12.6667C13.1971 13.3332 13.7058 13.1225 14.0809 12.7474C14.456 12.3723 14.6667 11.8636 14.6667 11.3332V4.6665C14.6667 4.13607 14.456 3.62736 14.0809 3.25229C13.7058 2.87722 13.1971 2.6665 12.6667 2.6665ZM3.33337 3.99984H12.6667C12.8435 3.99984 13.0131 4.07008 13.1381 4.1951C13.2631 4.32012 13.3334 4.48969 13.3334 4.6665L8.00004 7.91984L2.66671 4.6665C2.66671 4.48969 2.73695 4.32012 2.86197 4.1951C2.98699 4.07008 3.15656 3.99984 3.33337 3.99984ZM13.3334 11.3332C13.3334 11.51 13.2631 11.6796 13.1381 11.8046C13.0131 11.9296 12.8435 11.9998 12.6667 11.9998H3.33337C3.15656 11.9998 2.98699 11.9296 2.86197 11.8046C2.73695 11.6796 2.66671 11.51 2.66671 11.3332V6.1865L7.65337 9.23317C7.75472 9.29168 7.86968 9.32249 7.98671 9.32249C8.10373 9.32249 8.21869 9.29168 8.32004 9.23317L13.3334 6.1865V11.3332Z" fill="white" />
                  </svg>
                  <span className="main-color-2-text font-size-1 line-height-1">designer@webservice.com</span>
                </div>
                <div className="footer-item">
                  ...
                  <span className="main-color-2-text font-size-1 line-height-1">United States, 5th Avenue Street, New York City, 384846</span>
                </div>
                <div className="footer-item social">
                  ...
                  <a className="main-color-2-text font-size-1 line-height-1" href="#">Linkedin</a>
                  <a className="main-color-2-text font-size-1 line-height-1" href="#">Facebook</a>
                </div>
              </div>
            </div>
          </div>
