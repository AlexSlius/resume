...
const Estimation = ({
  ...
  return (
    <div className="languages-skill-item-value">
      {
        [...new Array(maketLeng)].map((_, index) => (
          <span key={index} className={`item-value-point additional-color-1-border ${(index + 1) <= pros ? "additional-color-1-background" : ""}`}></span>
        ))
      }
    </div>
  )
              ...
              <div className="profile-block profile-info-wrapper">
                {
                  isArray(contact) && (contact[0]?.firstName || contact[0]?.lastName) && (
                    <h1 className="cv-name">
                      {
                        isArray(contact) && (contact[0]?.firstName) && (
                          <span className="text-line-1 main-color-1-text font-weight-400 font-size-5 line-height-5">{contact[0]?.firstName}</span>
                        )
                      }
                      {
                        isArray(contact) && (contact[0]?.lastName) && (
                          <span className="text-line-2 main-color-1-text font-weight-700 font-size-4 line-height-4">{contact[0]?.lastName}</span>
                        )
                      }
                    </h1>
                  )
                }
                {
                  isArray(contact) && contact[0]?.jobTitle && (
                    <h2 className="prophecy-line main-color-1-text font-weight-400 font-size-3 line-height-3">{contact[0]?.jobTitle}</h2>
                  )
                }
                {
                  !!career_objective?.[0]?.data && (
                    <p className="profile-text main-color-1-text font-size-1 line-height-1" dangerouslySetInnerHTML={{ __html: career_objective?.[0]?.data }}></p>
                  )
                }
              </div>
            </div>
                      ...
                      <div className="details-wrapper">
                        {
                          !!contact?.[0]?.dateOfBirth && (
                            <div className="details-item font-size-1 line-height-1">
                              ...
                              <span className="item-value main-color-1-text font-weight-500">{moment(contact[0].dateOfBirth).format("DD-MM-yy")}</span>
                            </div>
                          )
                        }
                        {
                          !!contact?.[0]?.placeOfBirth && (
                            <div className="details-item font-size-1 line-height-1">
                              ...
                              <span className="item-value main-color-1-text font-weight-500 font-size-1 line-height-1">{contact?.[0]?.placeOfBirth}</span>
                            </div>
                          )
                        }
                        {
                          !!contact?.[0]?.nationality && (
                            <div className="details-item font-size-1 line-height-1">
                              ...
                              <span className="item-value main-color-1-text font-weight-500">{contact?.[0]?.nationality}</span>
                            </div>
                          )
                        }
                        {
                          !!contact?.[0]?.driverLicense && (
                            <div className="details-item font-size-1 line-height-1">
                              ...
                              <span className="item-value main-color-1-text font-weight-500 font-size-1 line-height-1">{contact?.[0]?.driverLicense}</span>
                            </div>
                          )
                        }
                      </div>
                        ...
                        education.map((itemEd, index) => (
                          <div key={index}>
                            <div>
                              {
                                (!!itemEd?.study) && (
                                  <p className="font-weight-600 main-color-1-text font-size-1 line-height-1">{!!itemEd?.study && (`${itemEd?.study}, `)}  {itemEd?.facility && (`${itemEd.facility}`)}</p>
                                )
                              }
                              {
                                itemEd?.degree && (
                                  <p className="font-weight-600 main-color-1-text font-size-1 line-height-1">{itemEd?.degree}</p>
                                )
                              }
                              {
                                (!!itemEd?.dateFrom?.date || !!itemEd?.dateTo?.date) && (
                                  <p className="date-range font-weight-300 font-size-1 line-height-1">
                                    {
                                      !!itemEd?.dateFrom?.date && (`${moment(itemEd?.dateFrom?.date).format("MMMM yy")} -`)} {!!itemEd?.dateTo?.date && (`${moment(itemEd?.dateTo?.date).format("MMMM yy")}`)
                                    }
                                  </p>
                                )
                              }
                            ...
                            {
                              !!itemEd?.description && (
                                <div className="font-size-1 line-height-1" dangerouslySetInnerHTML={{ __html: itemEd.description }}></div>
                              )
                            }
                          </div>
                        ))
                    ...
                    <div className="employment-history-block block-block">
                      ...
                      <span className="horizontal-line additional-color-1-border"></span>
                      {
                        employment.map((itemEm, index) => (
                          <div key={index}>
                            <p className="main-color-1-text font-weight-600 font-size-1 line-height-1">
                            ...
                            </p>
                            {
                              (!!itemEm?.periodFrom?.date || !!itemEm?.periodTo?.date) && (
                                <p className="date-range font-weight-300 font-size-1 line-height-1">{!!itemEm?.periodFrom?.date && (`${moment(itemEm?.periodFrom?.date).format("MMMM yy")} -`)} {!!itemEm?.periodTo?.date && (`${moment(itemEm?.periodTo?.date).format("MMMM yy")}`)}</p>
                              )
                            }
                            <div className="main-color-1-text font-size-1 line-height-1" dangerouslySetInnerHTML={{ __html: itemEm.assignment }}></div>
                          </div>
                        ))
                      }
                    </div>
                        ...
                        courses.map((itemCo, index) => (
                          <div key={index}>
                            <div>
                              {
                                !!itemCo?.title && (
                                  <p className="font-weight-600 main-color-1-text font-size-1 line-height-1">{itemCo?.title}</p>
                                )
                              }
                              {
                                (!!itemCo?.dateFrom?.date || !!itemCo?.dateTo?.date) && (
                                  <p className="date-range font-weight-300 font-size-1 line-height-1">{!!itemCo?.dateFrom?.date && (`${moment(itemCo?.dateFrom?.date).format("MMMM yy")} -`)} {!!itemCo?.dateTo?.date && (`${moment(itemCo?.dateTo?.date).format("MMMM yy")}`)}</p>
                                )
                              }
                            </div>
                            {
                    ...
                    <div className="certificates-block block-block">
                      ...
                      <span className="horizontal-line additional-color-1-border"></span>
                      {
                        certificates.map((item, index) => (
                          <p key={index} className="main-color-1-text font-weight-600 font-size-1 line-height-1">
                            <span key={index}>
                            ...
                            <div>
                              {
                                (!!itemEx?.title || itemEx?.employer) && (
                                  <p className="main-color-1-text font-weight-600 font-size-1 line-height-1">{!!itemEx?.title && (`${itemEx?.title},`)} {!!itemEx?.employer && (`${itemEx?.employer}`)}</p>
                                )
                              }
                              {
                                (
                                  !!itemEx?.dateFrom?.date || !!itemEx?.dateTo?.date) && (<p className="date-range main-color-1-text font-weight-300 font-size-1 line-height-1">{!!itemEx?.dateFrom?.date && (`${moment(itemEx?.dateFrom?.date).format("MMMM yy")} -`)} {!!itemEx?.dateTo?.date && (`${moment(itemEx?.dateTo?.date).format("MMMM yy")}`)}</p>
                                )
                              }
                            </div>
                            <div className="main-color-1-text font-size-1 line-height-1" dangerouslySetInnerHTML={{ __html: itemEx.description }}></div>
                          </div>
                        ))
                      }
                    </div>
                          ...
                          <div key={index}>
                            {
                              (!!itemIn?.jobTitle || itemIn?.employer || !!itemIn?.city) && (
                                <p className="main-color-1-text font-weight-600 font-size-1 line-height-1">{!!itemIn.jobTitle && (`${itemIn?.jobTitle},`)} {!!itemIn?.employer && (`${itemIn?.employer},`)} {!!itemIn?.city && (`${itemIn?.city}`)}</p>
                              )
                            }
                            {
                              (
                                !!itemIn?.dateFrom?.date || !!itemIn?.dateTo?.date) && (<p className="date-range main-color-1-text font-weight-300 font-size-1 line-height-1">{!!itemIn?.dateFrom?.date && (`${moment(itemIn?.dateFrom?.date).format("MMMM yy")} -`)} {!!itemIn?.dateTo?.date && (`${moment(itemIn?.dateTo?.date).format("MMMM yy")}`)}</p>
                              )
                            }
                            <div className="main-color-1-text font-size-1 line-height-1" dangerouslySetInnerHTML={{ __html: itemIn.description }}></div>
                          </div>
                        ))
                      }
                    </div>
                      ...
                      <div className="languages-list">
                        {
                          languages.map((item, index) => (
                            <div key={index} className="languages-list-item">
                              <p className="languages-list-item-name main-color-1-text font-weight-600 font-size-1 line-height-1">{item.language}</p>
                              <Estimation
                                level={item.level}
                                startLeng={6}
                              />
                          ...
                          <div key={index}>
                            {
                              (!!itemRef?.fullName || !!itemRef?.company) && (
                                <p className="company-name main-color-1-text font-weight-600 font-size-1 line-height-1">
                            ...
                            {
                              !!itemRef?.email && (
                                <p className="email main-color-1-text font-size-1 line-height-1">{itemRef.email}</p>
                              )
                            }
                            {
                              !!itemRef.phone && (
                                <p className="telephone main-color-1-text font-size-1 line-height-1">{itemRef.phone}</p>
                              )
                            }
                          </div>
                        ))
                  ...
                  <div className="bottom-block">
                    {
                      !!contact?.[0]?.phone && (
                        <div className="footer-item">
                          ...
                          <span className="main-color-2-text font-size-1 line-height-1">{contact?.[0]?.phone}</span>
                        </div>
                      )
                    }
                    {
                      !!contact?.[0]?.email && (
                        <div className="footer-item">
                          ...
                          <span className="main-color-2-text font-size-1 line-height-1">{contact?.[0]?.email}</span>
                        </div>
                      )
                    }
                    {
                      (!!contact[0]?.country || !!contact[0]?.city || !!contact[0]?.address || !!contact[0]?.zipCode) && (
                        <div className="footer-item">
                          ...
                          <span className="main-color-2-text font-size-1 line-height-1">{`${!!contact[0]?.country ? (`${contact[0]?.country},`) : ''} ${!!contact[0]?.address ? (`${contact[0]?.address},`) : ''} ${!!contact[0]?.city ? (`${contact[0]?.city},`) : ''} ${!!contact[0]?.zipCode ? contact[0]?.zipCode : ""}`}</span>
                        </div>
                      )
                    }
                    {
                        ...
                        <div className="footer-item social">
                          ...
                          </svg>
                          {
                            social_links.map((item, index) => (
                              <a key={index} className="main-color-2-text font-size-1 line-height-1">{item.name}</a>
                            ))
                          }
                        </div>
                      )
