...
export const ResumeCv006 = ({
  ...
  //         let top_area = $('#cv-body-hidden-container .top-area').clone();
  //         top_area.children().remove();
  //         page_element_container.append(top_area);
  //       }

  //       let middle_area = $('#cv-body-hidden-container .middle-area').clone();
  //       middle_area.children().remove();
  //       let column_left = $('#cv-body-hidden-container .middle-area .column-1').clone();
  //       column_left.children().remove();
  //       middle_area.append(column_left);
  //       let column_right = $('#cv-body-hidden-container .middle-area .column-2').clone();
              ...
              <div className="column-1">
                <div className="employment-history-block block-block">
                  <div className="left-side">
                    <p className="date-range font-weight-600 font-size-1 line-height-1">03/2022<br />‒ 12/2022</p>
                  </div>
                  <div className="right-side additional-color-1-border">
                    <span className="block-circle additional-color-1-background"></span>
                    <h3 className="heading-type-3 font-weight-700 font-size-2 line-height-2">Employment History</h3>
                    <p className="font-weight-600 font-size-1 line-height-1">Web Designer, Apple INC., New York City</p>
                    <div className="font-size-1 line-height-1">
                ...
                <div className="education-block block-block">
                  <div className="left-side">
                    <p className="date-range font-weight-600 font-size-1 line-height-1">07/2022<br />‒ 08/2022</p>
                  </div>
                  <div className="right-side additional-color-1-border">
                    <span className="block-circle additional-color-1-background"></span>
                    <h3 className="heading-type-3 font-weight-700 font-size-2 line-height-2">Education</h3>
                    <p className="font-weight-600 font-size-1 line-height-1">Marketing and Management, Harcum College, Portland</p>
                    <p className="font-weight-600 font-size-1 line-height-1">Bachelor</p>
                ...
                <div className="courses-block block-block">
                  ...
                  <div className="right-side additional-color-1-border">
                    <span className="block-circle additional-color-1-background"></span>
                    <h3 className="heading-type-3 font-weight-700 font-size-2 line-height-2">Courses</h3>
                    <p className="font-weight-600 font-size-1 line-height-1">Super course 1</p>
                ...
                <div className="extra-curricular-activities-block block-block">
                  ...
                  <div className="right-side additional-color-1-border">
                    <span className="block-circle additional-color-1-background"></span>
                    <h3 className="heading-type-3 font-weight-700 font-size-2 line-height-2">Extra-curricular activities</h3>
                    <p className="font-weight-600 font-size-1 line-height-1">UX Designer, My own company</p>
                    <p className="font-size-1 line-height-1">I was doing research for about five different projects. The goal was to find out the
                      biggest issues with the current concept and solution how to solve them.
                    </p>
                  </div>
                </div>
                ...
                <div className="education-block block-block">
                  ...
                  <div className="right-side additional-color-1-border">
                    <span className="block-circle additional-color-1-background"></span>
                    <h3 className="heading-type-3 font-weight-700 font-size-2 line-height-2">Internships</h3>
                    <p className="font-weight-600 font-size-1 line-height-1">Product Designer, Company S.A., Toronto</p>
                    <div className="font-size-1 line-height-1">
                ...
                <div className="references-block block-block additional-color-1-border">
                  ...
                  <div className="block-content-wrapper">
                    <span className="font-weight-600 font-size-1 line-height-1">Full name, Company</span>
                    <span className="font-size-1 line-height-1">references@webservice.com</span>
                    <span className="font-size-1 line-height-1">736-343-9384</span>
                  </div>
                </div>
              </div>
              <div className="column-2">
                <div className="languages-block block-block">
                  <h3 className="heading-type-3 font-weight-700 font-size-2 line-height-2">Languages</h3>
                  <div className="languages-list">
                    <div className="language-list-item">
                      ...
                      <p className="language-skill-estimation-wrapper">
                        <span className="estimation-value additional-color-1-background" style={{ width: "100%" }}></span>
                      </p>
                    </div>
                    <div className="language-list-item">
                      <p className="font-weight-600 font-size-1 line-height-1">Ukrainian</p>
                      <p className="language-skill-estimation-wrapper">
                        <span className="estimation-value additional-color-1-background" style={{ width: "70%" }}></span>
                      </p>
                    </div>
                    <div className="language-list-item">
                      <p className="font-weight-600 font-size-1 line-height-1">Russian</p>
                      <p className="language-skill-estimation-wrapper">
                        <span className="estimation-value additional-color-1-background" style={{ width: "30%" }}></span>
                      </p>
                    </div>
                  </div>
                </div>

                <div className="skills-block block-block additional-color-1-border">
                  <h3 className="heading-type-3 font-weight-700 font-size-2 line-height-2">Skills</h3>
                  <div className="skills-list">
                    <div className="skills-list-item">
                      <p className="font-weight-600 font-size-1 line-height-1">Computer Skills</p>
                      <div className="skill-estimation-point-list">
                        <svg className="additional-color-1-svg-path additional-color-1-svg" width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="skills-list-item">
                      <p className="font-weight-600 font-size-1 line-height-1">Adobe Illustrator</p>
                      <div className="skill-estimation-point-list">
                        <svg className="additional-color-1-svg-path additional-color-1-svg" width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M5 0L6.29313 3.22016L9.75528 3.45492L7.09232 5.67984L7.93893 9.04508L5 7.2L2.06107 9.04508L2.90768 5.67984L0.244718 3.45492L3.70687 3.22016L5 0Z" fill="#606C70" />
                        </svg>
                        ...
                        <svg className="additional-color-1-svg-path" width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M5 0L6.29313 3.22016L9.75528 3.45492L7.09232 5.67984L7.93893 9.04508L5 7.2L2.06107 9.04508L2.90768 5.67984L0.244718 3.45492L3.70687 3.22016L5 0Z" fill="#606C70" />
                        </svg>
                      </div>
                    </div>
                    ...
                    <div className="skills-list-item">
                      <p className="font-weight-600 font-size-1 line-height-1">Adobe Premiere Pro</p>
                      <div className="skill-estimation-point-list">
                        <svg className="additional-color-1-svg-path additional-color-1-svg" width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M5 0L6.29313 3.22016L9.75528 3.45492L7.09232 5.67984L7.93893 9.04508L5 7.2L2.06107 9.04508L2.90768 5.67984L0.244718 3.45492L3.70687 3.22016L5 0Z" fill="#606C70" />
                        </svg>
                    ...
                    <div className="skills-list-item">
                      <p className="font-weight-600 font-size-1 line-height-1">PowerPoint</p>
                      <div className="skill-estimation-point-list">
                        <svg className="additional-color-1-svg-path additional-color-1-svg" width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M5 0L6.29313 3.22016L9.75528 3.45492L7.09232 5.67984L7.93893 9.04508L5 7.2L2.06107 9.04508L2.90768 5.67984L0.244718 3.45492L3.70687 3.22016L5 0Z" fill="#606C70" />
                        </svg>
                    ...
                    <div className="skills-list-item">
                      <p className="font-weight-600 font-size-1 line-height-1">HTML5</p>
                      <div className="skill-estimation-point-list">
                        <svg className="additional-color-1-svg-path additional-color-1-svg" width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M5 0L6.29313 3.22016L9.75528 3.45492L7.09232 5.67984L7.93893 9.04508L5 7.2L2.06107 9.04508L2.90768 5.67984L0.244718 3.45492L3.70687 3.22016L5 0Z" fill="#606C70" />
                        </svg>
                    ...
                    <div className="skills-list-item">
                      <p className="font-weight-600 font-size-1 line-height-1">CSS</p>
                      <div className="skill-estimation-point-list">
                        <svg className="additional-color-1-svg-path additional-color-1-svg" width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M5 0L6.29313 3.22016L9.75528 3.45492L7.09232 5.67984L7.93893 9.04508L5 7.2L2.06107 9.04508L2.90768 5.67984L0.244718 3.45492L3.70687 3.22016L5 0Z" fill="#606C70" />
                        </svg>
                ...
                <div className="certificates-block block-block additional-color-1-border">
                  <h3 className="heading-type-3 font-weight-700 font-size-2 line-height-2">Certificates</h3>
                  <p className="font-size-1 line-height-1">Certificate name</p>
                </div>

                <div className="hobbies-block block-block additional-color-1-border">
                  <h3 className="heading-type-3 font-weight-700 font-size-2 line-height-2">Hobbies</h3>
                  <p className="font-size-1 line-height-1">Squash, Surfing, Swimming,
            ...
            <div className="cv-body-area bottom-area">
              <div className="bottom-block additional-color-1-background">
                <div className="footer-block">
                  ...
                  <span className="main-color-2-text font-weight-500 font-size-1 line-height-1">736-343-9384</span>
                </div>
                <div className="footer-block">
                  <svg className="main-color-2-svg" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="main-color-2-text font-weight-500 font-size-1 line-height-1">designer@webservice.com</span>
                </div>
                <div className="footer-block">
                  ...
                  <span className="main-color-2-text font-weight-500 font-size-1 line-height-1">United States, 5th Avenue Street, New York City, 384846</span>
                </div>
                <div className="footer-block">
                  ...
                  <a className="main-color-2-text font-weight-500 font-size-1 line-height-1" href="#">Linkedin</a>
                  <a className="main-color-2-text font-weight-500 font-size-1 line-height-1" href="#">Facebook</a>
                </div>
              </div>
            </div>
          </div>
