          ...
          <div className="cv-body-content font-size-1 main-color-1-text additional-color-1-background">
            ...
            <div className="middle-area">
              ...
              <div className="column-right">
                ...
                <div className={`education-block block-block m-right ${!education[0].study && !education[0].facility && !education[0].degree && !education[0].description && !education[0].dateFrom?.date && !education[0].dateTo?.date && !beforeСontent ? 'hide' : ''}`}>
