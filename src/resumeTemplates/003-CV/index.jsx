  ...
  React.useEffect(() => {
    if (typeof window != "undefined") {
      ...
      function rebuildingPages() {
        ...
        console.log("TEST height222s: ", getPageContainer(), getPageContainer().parent());
    ...
    <div className="sv_003" ref={reportTemplateRef}>
      <div id="cv-chapter-section-cv" className={`${stateClasses} cv-chapter-section has-photo color-scheme-state-color-set-0 `} data-chapter="cv">
        <div id="cv-body-hidden-container" className="cv-body">
          <div className="cv-body-content additional-color-2">
                ...
                (!!career_objective?.[0]?.data && career_objective?.[0]?.data != "<p></p>") && (
                  <div className="profile-info-block wrappable-block">
                    <div className="profile">
                      <h2 className="cv-heading heading-type-3 font-size-2 line-height-2 main-color-1-text">
                        Profile
                        <span className="line-after-block-heading additional-color-2-border"></span>
                      </h2>
                      <div className="font-size-1 line-height-1 main-color-1-text" dangerouslySetInnerHTML={{ __html: career_objective?.[0]?.data }}></div>
                    </div>
                  </div>
                )
              }
                  ...
                  <div className="details-block block-block wrappable-block main-color-1-border">
                    ...
                    }
                    {
                      isArray(social_links) && !!social_links.length && (
                        <div className="details-block-item career-social main-color-1-text font-size-1 line-height-1">
            ...
            <div className="cv-body-area area-2">
                    ...
                    <div className="employment-history-block block-block wrappable-block">
                      ...
                      </h3>
                      {
                        employment.map((itemEm, index) => (
                          <div className="employment-history-item" key={index}>
                            <div className="horizontal-wrap font-size-state-adaptation">
                              <p className="cv-heading block-subheading font-weight-600 font-size-1 line-height-1 main-color-1-text">
                                {
                                  !!itemEm?.title && (
                                    <span className="employment-position">{`${itemEm?.title}, `}</span>
                                  )
                                }
                              ...
                              </p>
                              {
                                (!!itemEm?.periodFrom?.date || !!itemEm?.periodTo?.date) && (
                                  <p className="date-range font-size-1 line-height-1 additional-color-2-text">{!!itemEm?.periodFrom?.date && (`${moment(itemEm?.periodFrom?.date).format("MMMM yy")} -`)} {!!itemEm?.periodTo?.date && (`${moment(itemEm?.periodTo?.date).format("MMMM yy")}`)}</p>
                                )
                              }
                            </div>
                        ...
                        education.map((itemEd, index) => (
                          <div key={index}>
                            <div className="horizontal-wrap">
                              {
                                (!!itemEd?.study) && (
                                  <p className="cv-heading block-subheading font-weight-600 font-size-1 line-height-1 main-color-1-text">{!!itemEd?.study && (`${itemEd?.study}, `)}  {itemEd?.facility && (`${itemEd.facility}, `)} {itemEd?.degree && (`${itemEd.degree}`)}</p>
                                )
                              }
                              {
                                (!!itemEd?.dateFrom?.date || !!itemEd?.dateTo?.date) && (
                                  <p className="date-range font-size-1 line-height-1 additional-color-2-text">
                                    {
                            ...
                            {/* <p className="horizontal-wrap education-text font-weight-600 font-size-1 line-height-1 main-color-1-text">Bachelor</p> */}
                            {
                              !!itemEd?.description && (
                        ...
                        courses.map((itemCo, index) => (
                          <div key={index}>
                            <div className="horizontal-wrap">
                              {
                                !!itemCo?.title && (
                                  <p className="cv-heading block-subheading font-weight-600 font-size-1 line-height-1 main-color-1-text">{itemCo?.title}</p>
                                )
                              }
                              {
                                (!!itemCo?.dateFrom?.date || !!itemCo?.dateTo?.date) && (
                                  <p className="date-range font-size-1 line-height-1 additional-color-2-text">{!!itemCo?.dateFrom?.date && (`${moment(itemCo?.dateFrom?.date).format("MMMM yy")} -`)} {!!itemCo?.dateTo?.date && (`${moment(itemCo?.dateTo?.date).format("MMMM yy")}`)}</p>
                                )
                              }
                            </div>
                            {
                              !!itemCo?.institution && (
                                <p className="courses-text font-weight-600 font-size-1 line-height-1 main-color-1-text">{itemCo?.institution}</p>
                              )
                            }
                          </div>
                        ))
                            ...
                            <div className="horizontal-wrap">
                              {
                                (!!itemEx?.title || itemEx?.employer) && (
                                  <p className="cv-heading block-subheading font-weight-600 font-size-1 line-height-1 main-color-1-text">{!!itemEx?.title && (`${itemEx?.title},`)} {!!itemEx?.employer && (`${itemEx?.employer}`)}</p>
                                )
                              }
                              {
                                (
                            ...
                            <div className="horizontal-wrap">
                              {
                                (!!itemIn?.jobTitle || itemIn?.employer || !!itemIn?.city) && (
                                  <p className="cv-heading block-subheading font-weight-600 font-size-1 line-height-1 main-color-1-text">{!!itemIn.jobTitle && (`${itemIn?.jobTitle},`)} {!!itemIn?.employer && (`${itemIn?.employer},`)} {!!itemIn?.city && (`${itemIn?.city}`)}</p>
                                )
                              }
                              {
                                (
              ...
              <div className="separator main-color-1-border"></div>
              <div className="column-right">
                {
                  isArray(languages) && !!languages.length && (
                    <div className="languages-block block-block wrappable-block">
                      <h3 className="cv-heading heading-type-3 font-size-1 line-height-1 main-color-1-text">
                        Languages
                        <span className="line-after-block-heading additional-color-2-border"></span>
                      </h3>
                ...
                {/* certificates */}
                {
                  isArray(certificates) && !!certificates.length && (
                    <div className="certificates-block block-block wrappable-block">
                      ...
                      <h3 className="cv-heading heading-type-3 font-size-2 line-height-2 main-color-1-text">
                        Certificates
                        <span className="line-after-block-heading additional-color-2-border"></span>
                      </h3>
                      {
                        certificates.map((item, index) => (
                          <p key={index} className="cv-heading heading-type-4 font-size-1 line-height-1 main-color-1-text">
                            <span key={index}>
                          ...
                          <div key={index}>
                            {
                              (!!itemRef?.fullName || !!itemRef?.company) && (
                                <p className="cv-heading heading-type-4 font-size-1 line-height-1 main-color-1-text">
