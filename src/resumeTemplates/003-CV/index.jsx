...
export const ResumeCv003 = ({
  ...
  return (
    <div className="sv_003" ref={refs}>
      <div id="cv-chapter-section-cv" class="cv-chapter-section" data-chapter="cv">
        <div id="cv-body-hidden-container" class="cv-body">
          <div class="cv-body-content additional-color-2">
            <div class="cv-body-area area-1">
              <div class="columns-wrapper additional-color-2-background">
                <div class="column-left">
                  <div class="personal-info-block">
                    <div id="photo-block" class="photo-block active">
                      <img class="cv-photo" src="./image/photo.jpg" />
                    </div>
                    <div class="cv-headings-wrap">
                      <h1 class="cv-heading cv-name main-color-1-text heading-type-1 font-size-3 line-height-3">
                        <span class="name-line-1 font-weight-400">MATTEW</span><br />
                        <span class="name-line-2 font-weight-600">MCCONAUGHEY</span>
                      </h1>
                      <h1 class="cv-heading cv-speciality font-weight-400 heading-type-2 main-color-1-text font-size-2 line-height-2">Web-designer</h1>
                    </div>
                  </div>
                </div>
                <div class="column-right">
                  <div class="profile-secondary-info wrappable-block main-color-1-border">
                    <div class="profile-item">
                      <span class="name main-color-1-text font-weight-300 font-size-1 line-height-1">Birth Date</span>
                      <span class="value main-color-1-text font-weight-700 font-size-1 line-height-1">14-08-1991</span>
                    </div>
                    <div class="profile-item">
                      <span class="name main-color-1-text font-weight-300 font-size-1 line-height-1">Place of Birth</span>
                      <span class="value main-color-1-text font-weight-700 font-size-1 line-height-1">Berlin</span>
                    </div>
                    <div class="profile-item">
                      <span class="name main-color-1-text font-weight-300 font-size-1 line-height-1">Nationality</span>
                      <span class="value main-color-1-text font-weight-700 font-size-1 line-height-1">German</span>
                    </div>
                    <div class="profile-item">
                      <span class="name main-color-1-text font-weight-300 font-size-1 line-height-1">Driving Licence</span>
                      <span class="value main-color-1-text font-weight-700 font-size-1 line-height-1">Class 1</span>
                    </div>
                  </div>
                </div>
              </div>
              <div class="profile-info-block wrappable-block">
                <div class="profile">
                  <h2 class="cv-heading heading-type-3 font-size-2 line-height-2 main-color-1-text">
                    Profile
              ...
              <div class="details-block block-block wrappable-block main-color-1-border">
                <div class="details-block-item career-phone main-color-1-text font-size-1 line-height-1">
                  ...
                  <span>736-343-9384</span>
                </div>
                <div class="details-block-item career-email main-color-1-text font-size-1 line-height-1">
                  <svg class="additional-color-1-svg" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span>designer@webservice.com</span>
                </div>
                <div class="details-block-item career-address main-color-1-text font-size-1 line-height-1">
                  <svg class="additional-color-1-svg" width="11" height="16" viewBox="0 0 11 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span class="font-size-state-adaptation">United States, 5th Avenue Street, New York City, 384846</span>
                </div>
                <div class="details-block-item career-social main-color-1-text font-size-1 line-height-1">
                  <svg class="additional-color-1-svg" width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="links-wrapper font-size-state-adaptation">
                    <a class="main-color-1-text font-size-1 line-height-1" href="#">Linkedin</a>
                    <a class="main-color-1-text font-size-1 line-height-1" href="#">Facebook</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="cv-body-area area-2">
              <div class="column-left wrappable-wrapper">
                <div class="employment-history-block block-block wrappable-block">
                  <h3 class="cv-heading heading-type-3 font-weight-600 font-size-2 line-height-2 main-color-1-text">
                    Employment history
                    <span class="line-after-block-heading additional-color-2-border"></span>
                  </h3>
                  <div class="employment-history-item">
                    <div class="horizontal-wrap font-size-state-adaptation">
                      <p class="cv-heading block-subheading font-weight-600 font-size-1 line-height-1 main-color-1-text">
                        <span class="employment-position">Web Designer,</span> <span class="company-and-city">Apple INC., New York City</span>
                      </p>
                      <p class="date-range font-size-1 line-height-1 additional-color-2-text">March 2022 - December 2022</p>
                    </div>
                    <ul>
                ...
                <div class="education-block block-block wrappable-block">
                  <h3 class="cv-heading heading-type-3 font-weight-600 font-weight-600 font-size-2 line-height-2 main-color-1-text">
                    Education
                    <span class="line-after-block-heading additional-color-2-border"></span>
                  </h3>
                  <div class="horizontal-wrap">
                    <p class="cv-heading block-subheading font-weight-600 font-size-1 line-height-1 main-color-1-text">Marketing and Management, Harcum College, Portland</p>
                    <p class="date-range font-size-1 line-height-1 additional-color-2-text">July 2022 - August 2022</p>
                  </div>
                  <p class="horizontal-wrap education-text font-weight-600 font-size-1 line-height-1 main-color-1-text">Bachelor</p>
                ...
                <div class="courses-block block-block wrappable-block">
                  ...
                  <div class="horizontal-wrap">
                    <p class="cv-heading block-subheading font-weight-600 font-size-1 line-height-1 main-color-1-text">Super course 1</p>
                    <p class="date-range font-size-1 line-height-1 additional-color-2-text">July 2022 - August 2022</p>
                  </div>
                  <p class="courses-text font-weight-600 font-size-1 line-height-1 main-color-1-text">Benjamin Franklin Sidestep Collage, Portland</p>
                </div>
                ...
                <div class="extra-curricular-activities-block block-block wrappable-block">
                  ...
                  <div class="horizontal-wrap">
                    <p class="cv-heading block-subheading font-weight-600 font-size-1 line-height-1 main-color-1-text">UX Designer, My own company</p>
                    <p class="date-range font-size-1 line-height-1 additional-color-2-text">March 2022 - December 2022</p>
                  </div>
                ...
                <div class="internships-block block-block wrappable-block">
                  ...
                  <div class="horizontal-wrap">
                    <p class="cv-heading block-subheading font-weight-600 font-size-1 line-height-1 main-color-1-text">Product Designer, Company S.A., Toronto</p>
                    <p class="date-range font-size-1 line-height-1 additional-color-2-text">March 2022 - December 2022</p>
                  </div>
                  <ul>
              ...
              <div class="separator main-color-1-border"></div>
              <div class="column-right">
                <div class="skills-block block-block wrappable-block">
                  <div class="horiz-line additional-color-1-border"></div>
                  <h3 class="cv-heading heading-type-3 font-weight-600 font-size-1 line-height-1 main-color-1-text">
                    Skills
                    <span class="line-after-block-heading additional-color-2-border"></span>
                  </h3>
                  <div class="skills-estimation-block">
                    <div class="skill-item">
                      ...
                      <div class="skill-estimation">
                        <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg" class="additional-color-1-svg-path additional-color-1-svg">
                          <path d="M5 0L6.29313 3.22016L9.75528 3.45492L7.09232 5.67984L7.93893 9.04508L5 7.2L2.06107 9.04508L2.90768 5.67984L0.244718 3.45492L3.70687 3.22016L5 0Z" fill="#A0A0A0" />
                        </svg>
                        <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg" class="additional-color-1-svg-path additional-color-1-svg">
                          <path d="M5 0L6.29313 3.22016L9.75528 3.45492L7.09232 5.67984L7.93893 9.04508L5 7.2L2.06107 9.04508L2.90768 5.67984L0.244718 3.45492L3.70687 3.22016L5 0Z" fill="#A0A0A0" />
                        </svg>
                        ...
                        <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg" class="additional-color-1-svg-path">
                          <path d="M5 0L6.29313 3.22016L9.75528 3.45492L7.09232 5.67984L7.93893 9.04508L5 7.2L2.06107 9.04508L2.90768 5.67984L0.244718 3.45492L3.70687 3.22016L5 0Z" fill="#A0A0A0" />
                        </svg>
                        <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg" class="additional-color-1-svg-path">
                          <path d="M5 0L6.29313 3.22016L9.75528 3.45492L7.09232 5.67984L7.93893 9.04508L5 7.2L2.06107 9.04508L2.90768 5.67984L0.244718 3.45492L3.70687 3.22016L5 0Z" fill="#A0A0A0" />
                ...
                <div class="languages-block block-block wrappable-block">
                  <h3 class="cv-heading heading-type-3 font-size-1 line-height-1 main-color-1-text">
                    Languages
                    <span class="line-after-block-heading additional-color-2-border"></span>
                  </h3>
                ...
                <div class="certificates-block block-block wrappable-block">
                  <div class="horiz-line additional-color-1-border"></div>
                  <h3 class="cv-heading heading-type-3 font-size-2 line-height-2 main-color-1-text">
                    Certificates
                    <span class="line-after-block-heading additional-color-2-border"></span>
                  </h3>
                  <p class="cv-heading heading-type-4 font-size-1 line-height-1 main-color-1-text">Certificate name</p>
                </div>
                <div class="references-block block-block wrappable-block">
                  ...
                  <p class="cv-heading heading-type-4 font-size-1 line-height-1 main-color-1-text">Full name, Company</p>
