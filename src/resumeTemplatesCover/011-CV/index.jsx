            ...
            <div className="column-left">
              {
                (firstName || lastName) && (
                  <div className="personal-data-block">
                    <div className="cv-name font-size-6 additional-color-2-text">
                    ...
                    {<>
                      <div className="block-item">
                        ...
                        <div className="right-side">
                          <div className="block-heading font-size-4 additional-color-3-text">To</div>
                        </div>
                      </div>
                      <div className="block-item">
                      ...
                      (state || city || zipCode || country || phone || email) && (
                        <>
                          <div className="block-item block-from">
                            <div className="left-side"></div>
                            <div className="right-side">
                              <div className="block-heading font-size-4 additional-color-3-text">From</div>
                              {
                                state && (
                                  <div className="additional-color-1-text">{state}</div>
                                )
                              }
                            </div>
                          </div>
                          <div className="block-item m-contacts">
                            <div className="left-side">
                            ...
                            <div className="right-side">
                              <div className="additional-color-1-text">
                          ...
                          </div>
                          {
                            phone && (
                              <div className="block-item m-contacts">
                                ...
                                <div className="right-side">
                                  <div className="additional-color-1-text">{phone}</div>
                                </div>
                              </div>
                            )
                          }
                          {
                            email && (
                              <div className="block-item m-contacts">
                                ...
                                <div className="right-side">
                                  <div className="additional-color-1-text">{email}</div>
                                </div>
                              </div>
                            )
                          }
