...
export const CoverCv039 = ({
  ...
  return (
    <div className="sv_039 template-wrapper" ref={reportTemplateRef}>
      <div id="cv-chapter-section-resume" className={`${stateClasses} cv-chapter-section`} data-chapter="resume">
        <div id="cv-body-2" data-chapter="resume" data-page="1" className="cv-body cv-body-2 additional-color-1-background">
          <div className="cv-body-content main-color-1-text font-size-1">
            <div className="column-left">
              {
                (firstName || lastName) && (
                  <div className="cv-name font-size-5 additional-color-1-text">{firstName && firstName} <br /> {lastName && lastName}</div>
                )
              }
              ...
              <div className="destination-block block-block">
                <div className="destination-contacts-block">
                  <div className="block-to">
                    <div className="block-heading font-size-2">To</div>
                    <div className="block-item" dangerouslySetInnerHTML={{ __html: data.to }}></div>
                  </div>
                  <div className="block-from">
                    <div className="block-heading font-size-2">From</div>
