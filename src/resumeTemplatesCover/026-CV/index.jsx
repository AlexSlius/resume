...
export const CoverCv026 = ({
  ...
  return (
    <div className="sv_026 template-wrapper" ref={reportTemplateRef}>
      <div id="cv-chapter-section-resume" className={`${stateClasses} cv-chapter-section`} data-chapter="resume">
        <div id="cv-body-2" className="cv-body cv-body-2">
          <div className="cv-body-content main-color-1-text font-size-1 additional-color-1-background">
            {
              (firstName || lastName) && (
