...
export const CoverCv029 = ({
  ...
  return (
    <div className="sv_029 template-wrapper" ref={reportTemplateRef}>
                ...
                <div className="profile-additional-info">
                  <div className="column-left">
                    <div className="footer-block">
                      ...
                      <div className="value" dangerouslySetInnerHTML={{ __html: data.to }}></div>
                    </div>
                  </div>
                    ...
                    }
                    {
                      (city || zipCode || country) && (
                        <div className="footer-block">
                          ...
                          <div className="value">{`${city ? (`${city}, `) : ""} ${zipCode ? (`${zipCode}, `) : ""} ${country ? (`${country}`) : ""}`}</div>
                        </div>
                      )
                    }
                    {
